...
class OVNClient(object):
    ...
    def _create_or_update_floatingip(self, floatingip, txn=None):
        ...
        if utils.is_nat_gateway_port_supported(self._nb_idl):
            ...
            # If LRP is not binded to a chassis, it means that router can be
            # binded instead. In this case we do not want to define gateway_port
            # LP#2083527.
            if lrp.options.get(ovn_const.LRP_OPTIONS_RESIDE_REDIR_CH) == 'true':
